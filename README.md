...
public class Pedro {
    ...
    private final String name = "Pedro Voltarelli";

    private final String username = "pxthedev";
    ...
    String passion =
        "Building scalable applications, Discord Bots and modern Backend systems.";
}
```
